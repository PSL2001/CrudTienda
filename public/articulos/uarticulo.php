...
$detallesArt = (new Articulos)->read($id);
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']."?id=$id" ?>" method="post">
            <div class="m-auto bg-primary text-white rounded p-4 shadow-lg" style="width: 48rem;">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Introduce el nombre aqui" value="<?php echo $detallesArt->nombre  ?>" required>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="precio" name="precio" placeholder="Introduce el precio aqui" value="<?php echo $detallesArt->precio  ?>" required>
                    <?php
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" name="categoria_id">
                        ...
                        foreach ($categorias as $item) {
                            if ($item->id == $detallesArt->categoria_id) {
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-outline-light" name="btnUpdate"><i class="fas fa-pen"></i> Actualizar</button>
